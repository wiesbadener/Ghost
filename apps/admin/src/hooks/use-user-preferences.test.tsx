...
describe("useUserPreferences", () => {
    ...
    describe("updatePreferences", () => {
        it("merges new preferences with existing ones", async () => {
            ...
            let lastPutBody: UpdateUserRequestBody | null = null;
            ...
            server.use(
                ...
                http.put("/ghost/api/admin/users/:id/", async ({ request }) => {
                    lastPutBody = await request.json() as UpdateUserRequestBody;
                    return HttpResponse.json({
                        users: [
                            {
                                ...mockUser,
        ...
        it("reflects updated preferences immediately after mutation", async () => {
            let accessibilityValue: string | null | undefined = null;
